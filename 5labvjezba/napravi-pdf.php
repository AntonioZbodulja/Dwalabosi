...
$pdf->Cell(100, 6, 'Krvna grupa', 1, 0, 'L', 1);
$pdf->Cell(30, 6, 'Prezime', 1, 0, 'R', 1);
...
$tbl_name="podacipacijenti"; // Table name
...
if(isset($_POST['krvnagrupa'], $_POST['krvnagrupaposneg'])) {
$krvnagrupa= $_POST['krvnagrupa'] . ' ' . $_POST['krvnagrupaposneg'];
}
else{
$krvnagrupa=" ";
}
...
$konekcija=mysqli_connect("localhost","root","","dwa") or die ("Neuspjesno spajanje na server"); 

mysqli_set_charset($konekcija, "utf8"); //da upis radi i sa utf-8 znakovima
...
while($row = mysqli_fetch_array($result))
{
    ...
    if ($i == $max)
    {
        ...
        $pdf->SetX(25);
        $pdf->Cell(30, 6, 'Ime', 1, 0, 'L', 1);
        $pdf->Cell(100, 6, 'Prezime', 1, 0, 'L', 1);
        $pdf->Cell(30, 6, 'Krvna grupa', 1, 0, 'R', 1);
